---
title: "Effect of (Version 0.1)- 20 user pilot: redo with RSE"
...
# Get pre-beef estimate
names(df)[names(df) == 'q17_5_text'] <- 'pre_beef'
names(df)[names(df) == 'q11_5_text'] <- 'post_beef'
names(df)[names(df) == 'q17_6_text'] <- 'pre_pork'
