---
title: "Effect of (Version 0.2)- 20 user pilot: redo with RSE"
...
```{r}
df = read.csv("Pilot3Cooked.csv")   #This file has some dummy data in which femail participants who see a feedlot video
...
# Refactor pet variables to True/False
df$has_dog <- df$has_dog == 'Dog'
df$has_cat <- df$has_cat == 'Cat'
df$has_bird <- is.na(df$has_bird) == FALSE #recode this if actual data has people with birds
