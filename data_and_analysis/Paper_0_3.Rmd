...
model1 = lm( beef_next_week ~ beef_last_week*vegetarian + factor(sex) + video_type + factor(sex)*factor(video_type), data=df)
#summary(model1)
```
...
model2 = lm( standardized_beef_last_week ~ standardized_beef_next_week*vegetarian + factor(sex) + video_type + factor(sex)*factor(video_type), data=df)
